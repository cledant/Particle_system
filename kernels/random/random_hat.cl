__kernel void random_hat(__global t_particle *particle, float2 minmax,
	...
	float3 center)
{
	...
	particle[i].pos.x = (z * cos(angle)) * minmax.y + center.x;
	particle[i].pos.y = (z * sin(angle)) * minmax.y + center.y;
	particle[i].pos.z = radius + z + minmax.y + center.z;
